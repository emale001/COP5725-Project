                        ...
                        try {
                            ...
                            if (action == null) {
                                ...
                                if (loc.equals("all")) {
                                    ...
                                    productlist = mngr.listByLocationId(Integer.parseInt(loc));
                                }
                            ...
                            while (itr2.hasNext()) {
                                ...
                                /* out.print(
                                        ...
                                        + "<input type=\"hidden\" name=\"getiditem\" value=\"" + info.getIditem() + "\">"
                                        + "<td> <button class=\"btn btn-success\" name=\"action\" value=\"deleterow\" type=\"submit\"><i class=\"icon-trash icon-white\"></i>Add To Cart</button></td>"
                                        + "</tr>"
                                        + "</form>"); */
                            }
                        } catch (Exception e) {
