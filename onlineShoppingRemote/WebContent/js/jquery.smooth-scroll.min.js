...
(function(l) {
    ...
    var e = "1.4.10", o = {exclude: [], excludeWithin: [], offset: 0, direction: "top", scrollElement: null, scrollTarget: null, beforeScroll: function() {
        }, afterScroll: function() {
        }, easing: "swing", speed: 400, autoCoefficent: 2}, r = function(t) {
    ...
    l.fn.extend({scrollable: function(l) {
            ...
            return this.unbind("click.smoothscroll").bind("click.smoothscroll", function(e) {
                ...
                if (o.scrollTarget || d && m && p) {
                    ...
                    h = !1;
                h && (e.preventDefault(), l.extend(u, o, {scrollTarget: o.scrollTarget || p, link: n}), l.smoothScroll(u))
            }), this
